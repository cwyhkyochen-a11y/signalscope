...
function start() {
  ...
  cron.schedule('* * * * *', async () => {
      ...
      try {
        ...
        switch (task.type) {
          ...
          case 'reddit_rss':
            ...
            break;
          case 'youtube_rss':
            await youtubeWorker.syncSource(source);
            break;
          default:
    ...
    try {
      ...
      console.error('[scheduler] Day-summary error:', e.message);
    }
  });
}
