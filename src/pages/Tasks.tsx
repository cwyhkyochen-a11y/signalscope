...
import { Play, Pause, PlayCircle, ListTodo } from 'lucide-react'
  ...
  return (
    <div>
      ...
      {loading ? <Skeleton lines={5} /> : tasks.length === 0 ? (
        <EmptyState icon={ListTodo} title="No tasks yet" description="Create a source to auto-generate collection tasks." />
      ) : (
