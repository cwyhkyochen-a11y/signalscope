...
export default function Dashboard() {
  ...
  if (!data) return <p style={{ color: 'var(--color-text-secondary)' }}>No data available</p>
  ...
  return (
    <div>
      ...
      {!contents || contents.length === 0 ? (
        <p className="text-sm" style={{ color: 'var(--color-text-tertiary)' }}>No content today yet.</p>
      ) : (
